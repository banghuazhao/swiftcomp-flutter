...
class MockUserUseCase extends Mock implements UserUseCase {
  @override
  Future<User> fetchMe() => super.noSuchMethod(Invocation.method(#fetchMe, []),
  ...
  @override
  Future<void> updateMe(String newName) => super.noSuchMethod(
  ...
  @override
  Future<void> deleteAccount() => super.noSuchMethod(
