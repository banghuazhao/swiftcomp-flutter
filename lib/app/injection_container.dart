...
void initInjection() {
  ...
  sl.registerFactory<ThreadsUseCase>(() => ThreadsUseCaseImpl(repository: sl()));
  sl.registerFactory<ThreadRunsUseCase>(() => ThreadRunsUseCaseImpl(repository: sl()));
  sl.registerFactory<MessagesUseCase>(() => MessagesUseCaseImpl(repository: sl()));
