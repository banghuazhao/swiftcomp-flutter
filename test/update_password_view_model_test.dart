  ...
  group('UpdatePasswordViewModel Tests', () {
    group('toggleNewPasswordVisibility', () {
      test('should toggle obscureTextNewPassword and notify listeners', () {
        ...
        final UpdatePasswordViewModel updatePasswordViewModel =
            UpdatePasswordViewModel(authUseCase: mockAuthUseCase);
    ...
    group('toggleConfirmPasswordVisibility', () {
      test('should toggle obscureTextConfirmPassword and notify listeners', () {
        final MockAuthUseCase mockAuthUseCase = MockAuthUseCase();
        final UpdatePasswordViewModel forgetPasswordViewModel =
            UpdatePasswordViewModel(authUseCase: mockAuthUseCase);
    ...
    group('updatePassword', () {
      test('should set isLoading to true and back to false during the process',
          () async {
        final MockAuthUseCase mockAuthUseCase = MockAuthUseCase();
        final UpdatePasswordViewModel forgetPasswordViewModel =
            UpdatePasswordViewModel(authUseCase: mockAuthUseCase);
        ...
        when(mockAuthUseCase.updatePassword(currentPassword, newPassword))
            .thenAnswer((_) async => successMessage);

        final future = forgetPasswordViewModel.updatePassword(
      ...
      test('should call updatePassword with the correct new password',
          () async {
        final MockAuthUseCase mockAuthUseCase = MockAuthUseCase();
        final UpdatePasswordViewModel forgetPasswordViewModel =
            UpdatePasswordViewModel(authUseCase: mockAuthUseCase);
        ...
        await forgetPasswordViewModel.updatePassword(
            currentPassword, newPassword);

        verify(mockAuthUseCase.updatePassword(currentPassword, newPassword))
            .called(1);
      });
      ...
      test('should set and return errorMessage on failure', () async {
        ...
        expect(
            forgetPasswordViewModel.errorMessage, 'Failed to update password.');
      });
